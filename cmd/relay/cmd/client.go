...
var clientCmd = &cobra.Command{
	...
	Long: `Connect to a relay to exchange text data with a host.

you must set the environment variables RELAY_CLIENT_SESSION and RELAY_CLIENT_TOKEN

e.g. 
export RELAY_CLIENT_SESSION=https://relay-access.practable.io/session/govn05-data
export RELAY_CLIENT_TOKEN=ey... #include complete JWT token
`,
