...
func (o *GetGroupDescriptionByIDURL) WithBasePath(bp string) *GetGroupDescriptionByIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetGroupDescriptionByIDURL) Build() (*url.URL, error) {
	...
	var _path = "/groups/{group_id}"

	groupID := o.GroupID
	if groupID != "" {
		_path = strings.Replace(_path, "{group_id}", groupID, -1)
	} else {
		return nil, errors.New("groupId is required on GetGroupDescriptionByIDURL")
	}
...
func (o *GetGroupDescriptionByIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetGroupDescriptionByIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetGroupDescriptionByIDURL")
	}
