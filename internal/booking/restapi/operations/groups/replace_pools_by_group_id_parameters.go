...
// ReplacePoolsByGroupIDParams contains all the bound params for the replace pools by group ID operation
...
func (o *ReplacePoolsByGroupIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReplacePoolsByGroupIDParams) bindGroupID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
