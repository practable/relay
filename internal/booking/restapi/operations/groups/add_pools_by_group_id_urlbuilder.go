...
func (o *AddPoolsByGroupIDURL) Build() (*url.URL, error) {
	...
	if groupID != "" {
		...
		return nil, errors.New("groupId is required on AddPoolsByGroupIDURL")
	}
...
func (o *AddPoolsByGroupIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on AddPoolsByGroupIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on AddPoolsByGroupIDURL")
	}
