...
/*GetActivityByIDUnauthorized handles this case with default header values.
...
/*GetActivityByIDNotFound handles this case with default header values.
...
/*GetActivityByIDInternalServerError handles this case with default header values.
