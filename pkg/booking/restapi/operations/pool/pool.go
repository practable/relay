...
type PoolHandlerFunc func(PoolParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PoolHandlerFunc) Handle(params PoolParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// PoolHandler interface for that can handle valid pool params
type PoolHandler interface {
	Handle(PoolParams, interface{}) middleware.Responder
}
