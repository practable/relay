...
func (o *ReplacePoolsByGroupIDURL) WithBasePath(bp string) *ReplacePoolsByGroupIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ReplacePoolsByGroupIDURL) Build() (*url.URL, error) {
	...
	if groupID != "" {
		...
		return nil, errors.New("groupId is required on ReplacePoolsByGroupIDURL")
	}
...
func (o *ReplacePoolsByGroupIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ReplacePoolsByGroupIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ReplacePoolsByGroupIDURL")
	}
