...
func (o *GetPoolDescriptionByIDURL) WithBasePath(bp string) *GetPoolDescriptionByIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetPoolDescriptionByIDURL) Build() (*url.URL, error) {
	...
	if poolID != "" {
		...
		return nil, errors.New("poolId is required on GetPoolDescriptionByIDURL")
	}
...
func (o *GetPoolDescriptionByIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetPoolDescriptionByIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetPoolDescriptionByIDURL")
	}
